...
This is my introduction to *markdown formatting*. I'm learning how to use various formatting options so that i can style my report.
...
Here's a simple Python exapmle:
